...
class CardStack extends React.Component {
  ...
  render() {
    const {
      ...
      onGestureEnd,
      onGestureCancel,
      detachInactiveScreens = _reactNative.Platform.OS === 'ios' ? false // Disable `react-native-screens` on iOS by default since it's buggy
      : _Screens.shouldUseActivityState || mode !== 'modal' // Enable on new versions of screens or for non modals on older versions
